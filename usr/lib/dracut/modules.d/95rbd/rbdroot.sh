...
rbd map --id diskless-client --keyring /etc/ceph/ceph.client.diskless-client.keyring $rbd_name --pool $rbd_pool || die "Unable to mount rbd device \"$rbd_name\" from pool \"$rbd_pool\""
